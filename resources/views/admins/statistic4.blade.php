                            ...
                            <table class="w-100 bg-white" style="box-shadow: 0 0 10px rgb(231, 231, 231);">
                                <tr class="">
                                    <th style="font-size: 14px;"><button style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Client Name</th>
                                    <th style="font-size: 14px;"><button style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Phone</th>
                                    <th style="font-size: 14px;"><button style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Visit Date</th>
                                    <th style="font-size: 14px;"><button style="background: transparent;border: none;"><i
                                    ...
                                    <th style="font-size: 14px;"><button style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Hint</th>
                                    </th>
                                </tr>
                                <tr class="my-3">
                                    <td>0595063676</td>
