...
<body>
        ...
        <div class="popup2_">
            <div class="card_pop">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="number" name="" id="name_order" placeholder="Phone">
                    </div>
                    <div class="form-group">
                        <input type="email" name="" id="name_order" placeholder="Email">
                    </div>
                    <div class="form-group">
                        <select name="" id="name_order" class="sels">
        ...
        <div class="col-lg-10 main-content p-0 main_">
            ...
            <div class="container">
                <div class="content-body pt-5 px-3">
                    ...
                    <div class="statistic_parent col-lg-12">
                        <button class="btn btn-outline-primary ml-3 mb-3" id="add_">Add</button>
                        <div class="table_ col-lg-12">
                            <table class="w-100 bg-white" style="box-shadow: 0 0 10px rgb(231, 231, 231);">
                                <tr class="">
                                    <th style="font-size: 14px;"><button
                                    ...
                                    <th style="font-size: 14px;"><button
                                            style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Permission</th>
                                    </th>
                                    <th style="font-size: 14px;"><button
                                            style="background: transparent;border: none;"><i
                                    ...
                                    <th style="font-size: 14px;"><button
                                            style="background: transparent;border: none;"><i
                                                class="fas fa-sort-amount-down-alt"></i></button>Resend Password</th>
                                    </th>
                                ...
                                <tr class="my-3">
                                    ...
                                    <td>Ahmed Ramin</td>
                                    <td>Ahmed Ramin</td>
                                    <td><button class="btn btn-primary" id="edit_">Edit</button></td>
                                </tr>
                                <tr class="my-3">
                                    <td>0595063676</td>
                                    <td>Ahmed Ramin</td>
    ...
    <script>
        $(document).ready(function () {
            ...
            var btn_ed = document.querySelectorAll('#edit_');
            btn_ed.forEach(edit_ => {
