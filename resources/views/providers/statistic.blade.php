                    ...
                    <div class="tabel_content">
                        ...
                        <div class="bodys">
                            <div class="body_content d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-between"><span class="mr-4 text-dark">1</span><span class="text-dark">Ahmed
                                        Mohsen</span></div>
                                <p>222</p>
            ...
            <div class="container">
                <div class="content-body pt-5 px-3">
                    ...
                    <div class="statistic_parent col-lg-12 d-flex justify-content-between">
                        <div class="table_ col-lg-8">
                          <form class="bg-white py-3">
                            <div class="d-flex justify-content-around">
                                <input  style="width: 20%;" type="date" name="" id="search_in">
                                <input style="width: 20%;" type="date" name="" id="search_in">
                            ...
                            <table class="w-100 bg-white" style="box-shadow: 0 0 10px rgb(231, 231, 231);">
                                <tr class="">
                                    <th><button style="background: transparent;border: none;"><i class="fas fa-sort-amount-down-alt"></i></button>Client Number</th>
                                    <th><button style="background: transparent;border: none;"><i class="fas fa-sort-amount-down-alt"></i></button>Date</th>
                                    <th><button style="background: transparent;border: none;"><i class="fas fa-sort-amount-down-alt"></i></button>Price</th>
                                </tr>
                                <tr class="my-3">
                                    <td>0595063676</td>
                                    <td>Ahmed Ramin</td>
                        ...
                        <div class="_statistic_ col-lg-4">
                            <div class="stc mb-2 bg-white d-flex justify-content-between align-items-center p-4 w-100" style="box-shadow: 0 0 10px rgb(231, 231, 231);border-left: 5px solid #5F5AFF;">
                                <p class="m-0">Today's sums</p>
                                <p class="m-0">22</p>
                            </div>
                            <div class="stc mb-2 bg-white d-flex justify-content-between align-items-center p-4 w-100" style="box-shadow: 0 0 10px rgb(231, 231, 231);border-left: 5px solid #fd0bb4;">
                                <p class="m-0">Week</p>
                                <p class="m-0">2</p>
                            </div>
                            <div class="stc mb-2 bg-white d-flex justify-content-between align-items-center p-4 w-100" style="box-shadow: 0 0 10px rgb(231, 231, 231);border-left: 5px solid #5F5AFF;">
                    ...
                    <div class="col-lg-12 table__ mx-3 mt-5">
                        <h3>Lorem</h3>
                        <table class="w-50 bg-white" style="box-shadow: 0 0 10px rgb(231, 231, 231);">
                            <tr class="">
                                <th><input style="width: 77%;" type="search" name="" id="search_in"></th>
                                <th><input style="width: 77%;" type="search" name="" id="search_in"></th>
                            </tr>
                            <tr class="">
                                <th><button style="background: transparent;border: none;"><i class="fas fa-sort-amount-down-alt"></i></button>Month</th>
                                <th><button style="background: transparent;border: none;"><i class="fas fa-sort-amount-down-alt"></i></button>attachment</th>
                            </tr>
                            <tr class="my-3">
                                <td>12</td>
                                <td><img width="120px" height="120px" src="../images/mens.png" alt=""></td>
                            </tr>
                            <tr class="my-3">
                                <td>12</td>
                                <td><img width="120px" height="120px" src="../images/mens.png" alt=""></td>
